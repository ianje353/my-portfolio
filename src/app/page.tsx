          ...
          <div className="container flex h-14 items-center justify-between px-4">
            <div className="flex">
              <Link href="/" className="flex items-center space-x-2">
                <span className="font-bold text-lg sm:text-xl">Portfolio</span>
              </Link>
            </div>
            ...
            <div className="flex justify-center mb-8">
              <div className="relative">
                ...
                <Image
                  ...
                  height={400}
                  priority
                  className="relative rounded-full border-4 border-background shadow-2xl w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 object-cover"
                />
              </div>
            </div>
